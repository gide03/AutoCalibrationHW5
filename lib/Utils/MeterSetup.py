...
class MeterSetup(RegisterWrapper):
    def __init__(self):
        ...
        self.Aux_switch_pre_cross_halfms = Register('Aux_switch_pre_cross_halfms', 'uint8', 10)
        self.LCR1_switch_bistable_open_halfms_pulse_width = Register('LCR1_switch_bistable_open_halfms_pulse_width', 'uint8', 0)
        self.LCR1_switch_bistable_close_halfms_pulse_width = Register('LCR1_switch_bistable_close_halfms_pulse_width', 'uint8', 0)
        self.LCR1_switch_pre_cross_halfms = Register('LCR1_switch_pre_cross_halfms', 'uint8', 45)
        self.LCR2_switch_bistable_open_halfms_pulse_width = Register('LCR2_switch_bistable_open_halfms_pulse_width', 'uint8', 0)
        self.LCR2_switch_bistable_close_halfms_pulse_width = Register('LCR2_switch_bistable_close_halfms_pulse_width', 'uint8', 45)
        self.LCR2_switch_pre_cross_halfms = Register('LCR2_switch_pre_cross_halfms', 'uint8', 0)
